    ...
    -- Font importing system 
        local fonts = {}; do
            ...
            local TahomaBold = Register_Font("TahomaBold", 200, "normal", {
                Id = "TahomaBold.ttf",
                Font = game:HttpGet("https://github.com/chrissimpkins/codeface/raw/refs/heads/master/fonts/proggy-clean/ProggyClean.ttf"),
            })
            ...
            fonts = {
                ["TahomaBold"] = Font.new(ProggyClean, Enum.FontWeight.Regular, Enum.FontStyle.Normal);
